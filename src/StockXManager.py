...
class StockXManager:
    def __init__(self, delay_min=0.1, delay_max=0.2):
        ...
        self.last_page = 25
        self.auth_token = 'Bearer eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCIsImtpZCI6Ik5USkNNVVEyUmpBd1JUQXdORFk0TURRelF6SkZRelV4TWpneU5qSTNNRFJGTkRZME0wSTNSQSJ9..PoG7FDQO-Irhb5Q5O_RfcS2V4DM8DAepY5UHKCctT5fTzdQLcupAuzVIA8mE_3oyUy-po1xQhXfj3C_-Y7RT3Nyf3WxlPx1ZIYAITBO7ysYpMJ9XjF_aS8vsNONrdRg8iB49szKtv53bs8r-YDS3kcUab22l12dDap9ziT-PqMTYikqW4IFMgNS1HIvvf7s8Gn14-6mx04Na9GYF2AXQ9gxTRlPEIOupajpzQuBl9hVfjbPQkpeCcB9UZZCzlK-AWrPzdozyfnMEzfblmU4UpMtXs7FUjfs2RXdtIum1LMG5w7UHsujx-Buy1gJyP-9SCiQ3JX7TcpNg5Fq4aMO2hQ'
        pass
    ...
    def _post_price(self, urlkey):
        ...
        headers = {
            ...
            'Cookie' : 'stockx_device_id=052ebc20-b6ba-48e5-b3a9-d94b8a64df2a; _pxvid=c4e2bbe4-9976-11ed-aab3-575552764d57; _ga=GA1.2.569109511.1674297091; ajs_anonymous_id=6593169f-2cec-4748-8a84-ab935ea5f813; __pxvid=c514f26d-9976-11ed-b321-0242ac120002; _gcl_au=1.1.1570150577.1674297091; rbuid=rbos-dc1e4acd-a291-490d-8242-4de37a93dd1c; __ssid=ac2c621ce974a5208576220bbae4656; rskxRunCookie=0; rCookie=03bentcw3fenxkvyo8zwuwld5t9dhl; QuantumMetricUserID=1c8a556b683048d6ddc5c111fbd718ef; _rdt_uuid=1674297095164.6a485bc7-e5a6-4d1a-8558-b7530720ed13; __pdst=40f158377cfa4d989f101edd0779df41; _ga=GA1.2.569109511.1674297091; _pin_unauth=dWlkPVl6QTFaREptTkRVdE9EYzJOeTAwTkRjeExUaGpaVFF0TkRBeFpEWmxOVGhpTURCbA; stockx_dismiss_modal=true; stockx_dismiss_modal_set=2023-01-24T11%3A38%3A45.532Z; stockx_dismiss_modal_expiration=2024-01-24T11%3A38%3A45.531Z; OptanonAlertBoxClosed=2023-01-24T11:38:50.156Z; tracker_device=10696ba6-010f-4b51-ae75-4a2982e6baf8; stockx_seen_ask_new_info=true; ajs_user_id=bf8d3023-9c4b-11ed-9f0c-124738b50e12; mfaLogin=err; language_code=ko; ajs_user_id=bf8d3023-9c4b-11ed-9f0c-124738b50e12; ajs_anonymous_id=6593169f-2cec-4748-8a84-ab935ea5f813; stockx_homepage=sneakers; _gid=GA1.2.1218620974.1677248496; stockx_selected_region=KR; pxcts=6b9d7660-b4de-11ed-816a-6a7464564b6f; IR_gbd=stockx.com; stockx_preferred_market_activity=sales; token=eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCIsImtpZCI6Ik5USkNNVVEyUmpBd1JUQXdORFk0TURRelF6SkZRelV4TWpneU5qSTNNRFJGTkRZME0wSTNSQSJ9..Wc-ULfqxC7TsxFYdfaUYbFUBhsjiUE8m-SXlEsEMaXCqly6n4j4RFMdY30pNc5-F8gAD2Zlh629tbbtgWuXANJhyy5nrzQyZnRWcB2edMDNwfw5vQvXTJsqIe5V3r2bYztyrpEjLz9AsKr2jIWTdok0d9psmZ6YU-Nco7Z2M8YQE7PI5zWySHR2Mb7eQlxovF9D0nnxqLXy5RhQFyK1YtWS2G3uIcErXgB5BeO4sRoHKSY4NrjA8bnaVKRe9IfKtB0oiWfiT-j9o1EgtQSAUAkLDjQKygIzg29zknJzoIgcLAQHom4tgfgypFNGXtdnEca8QCBVarsVpsj2UHunKEg; stockx_default_size=%7B%22sneakers%22%3A%2211%22%2C%22shoes%22%3A%2211%22%7D; __cf_bm=dxUIFyqBPBb7uoon.ndKd.YV0HsfQ8wY8t4XSVdwBxE-1677408820-0-AdKnYZqrLsd27HbGkmG5ciBogK/t5klFzsjWtwmtCBfhdWXFb/f9dyTpbWRgJ6WlAYeBZG0VIXHhDTa2Og4J3S0=; stockx_session=39eeb3cd-a2fe-474f-827c-b831778347ed; _pxff_cc=U2FtZVNpdGU9TGF4Ow==; _pxff_idp_c=1,s; _pxff_fed=5000; _pxff_tm=1; _gat=1; QuantumMetricSessionID=3670c23926377f5ac592c3ea3ac9276a; _pxff_rf=1; _pxff_fp=1; _px3=3585c6c0a14be3470f191ab91857c0184af1ab7347568be6b5374fdeef578dac:WJeImq3tL9udmBqiy2A5SNmfnq3I887KHiEEvc2mpuCmYKwAAEaMDCeSm5aUYftE40l8bX1md/UDQf2DPoiUmg==:1000:PnVS63NgPPz+I5HNsZj0gx+a98d893DJJQSpWWXtbrPLYYbo+h12lpJcRkRfryYFN9yOC136tJ0plg0sCLubJtVw9JKMFaBvL1ubLbTulTYVOpmB5aW0sHe87r3i75M+8wgnrBbI2R2ycAge9/d3pHbsfFpVPu5/IhEa+lU+ZtfxrRreeM/HoCEc7xW+QF8xF/AnWNeeHaEObhWKqslyjg==; loggedIn=bf8d3023-9c4b-11ed-9f0c-124738b50e12; stockx_selected_currency=USD; forterToken=4880e3a1bc124c478eaa6ecf50b63162_1677408870516__UDF43_13ck; ftr_blst_1h=1677408870744; _uetsid=8bce61e0b44e11edb4b0cd03196d701d; _uetvid=b24a09e09c4d11edae7967fe428be46d; lastRskxRun=1677408873076; IR_9060=1677408874418%7C0%7C1677408874418%7C%7C; IR_PI=c7c35067-9976-11ed-b9f8-25af62750bf1%7C1677495274418; _pxde=b8e65e6f894032310640c025e2e530e15665f66cdb78afbfc190500c0109dea8:eyJ0aW1lc3RhbXAiOjE2Nzc0MDg4NzYwNjksImZfa2IiOjB9; OptanonConsent=isGpcEnabled=0&datestamp=Sun+Feb+26+2023+19%3A54%3A39+GMT%2B0900+(%ED%95%9C%EA%B5%AD+%ED%91%9C%EC%A4%80%EC%8B%9C)&version=202211.2.0&geolocation=KR%3B11&isIABGlobal=false&hosts=&consentId=68357594-217d-4425-9343-9c5309623e84&interactionCount=1&landingPath=NotLandingPage&groups=C0001%3A1%2CC0002%3A1%2CC0004%3A1%2CC0005%3A1%2CC0003%3A1&AwaitingReconsent=false; _dd_s=rum=0&expire=1677409779433; stockx_product_visits=27'
        }
        payload = json.dumps({
            "query": "query GetMarketData($id: String!, $currencyCode: CurrencyCode, $countryCode: String!, $marketName: String) {\n  product(id: $id) {\n    id\n    urlKey\n    market(currencyCode: $currencyCode) {\n      bidAskData(country: $countryCode, market: $marketName) {\n        highestBid\n        highestBidSize\n        lowestAsk\n        lowestAskSize\n      }\n    }\n    variants {\n      id\n      market(currencyCode: $currencyCode) {\n        bidAskData(country: $countryCode, market: $marketName) {\n          highestBid\n          highestBidSize\n          lowestAsk\n          lowestAskSize\n        }\n      }\n    }\n    ...BidButtonFragment\n    ...BidButtonContentFragment\n    ...BuySellFragment\n    ...BuySellContentFragment\n    ...XpressAskPDPFragment\n  }\n}\n\nfragment BidButtonFragment on Product {\n  id\n  title\n  urlKey\n  sizeDescriptor\n  productCategory\n  market(currencyCode: $currencyCode) {\n    bidAskData(country: $countryCode, market: $marketName) {\n      highestBid\n      highestBidSize\n      lowestAsk\n      lowestAskSize\n    }\n  }\n  media {\n    imageUrl\n  }\n  variants {\n    id\n    market(currencyCode: $currencyCode) {\n      bidAskData(country: $countryCode, market: $marketName) {\n        highestBid\n        highestBidSize\n        lowestAsk\n        lowestAskSize\n      }\n    }\n  }\n}\n\nfragment BidButtonContentFragment on Product {\n  id\n  urlKey\n  sizeDescriptor\n  productCategory\n  lockBuying\n  lockSelling\n  minimumBid(currencyCode: $currencyCode)\n  market(currencyCode: $currencyCode) {\n    bidAskData(country: $countryCode, market: $marketName) {\n      highestBid\n      highestBidSize\n      lowestAsk\n      lowestAskSize\n      numberOfAsks\n    }\n  }\n  variants {\n    id\n    market(currencyCode: $currencyCode) {\n      bidAskData(country: $countryCode, market: $marketName) {\n        highestBid\n        highestBidSize\n        lowestAsk\n        lowestAskSize\n        numberOfAsks\n      }\n    }\n  }\n}\n\nfragment BuySellFragment on Product {\n  id\n  title\n  urlKey\n  sizeDescriptor\n  productCategory\n  lockBuying\n  lockSelling\n  market(currencyCode: $currencyCode) {\n    bidAskData(country: $countryCode, market: $marketName) {\n      highestBid\n      highestBidSize\n      lowestAsk\n      lowestAskSize\n    }\n  }\n  media {\n    imageUrl\n  }\n  variants {\n    id\n    market(currencyCode: $currencyCode) {\n      bidAskData(country: $countryCode, market: $marketName) {\n        highestBid\n        highestBidSize\n        lowestAsk\n        lowestAskSize\n      }\n    }\n  }\n}\n\nfragment BuySellContentFragment on Product {\n  id\n  urlKey\n  sizeDescriptor\n  productCategory\n  lockBuying\n  lockSelling\n  market(currencyCode: $currencyCode) {\n    bidAskData(country: $countryCode, market: $marketName) {\n      highestBid\n      highestBidSize\n      lowestAsk\n      lowestAskSize\n    }\n  }\n  variants {\n    id\n    market(currencyCode: $currencyCode) {\n      bidAskData(country: $countryCode, market: $marketName) {\n        highestBid\n        highestBidSize\n        lowestAsk\n        lowestAskSize\n      }\n    }\n  }\n}\n\nfragment XpressAskPDPFragment on Product {\n  market(currencyCode: $currencyCode) {\n    state(country: $countryCode) {\n      numberOfCustodialAsks\n    }\n  }\n  variants {\n    market(currencyCode: $currencyCode) {\n      state(country: $countryCode) {\n        numberOfCustodialAsks\n      }\n    }\n  }\n}\n",
            "variables": {
